...
| Métrica | Valor | Fonte |
|---------|-------|-------|
| Tests | **1096/1096** ✅ default + **18/18** ✅ test:soak (deep-soak isolado) | `vitest run` 2026-05-12 |
| Test files | 95 | `find tests -name "*.test.js"` |
| Specs totais | **116** | `find specs -name "SPEC-*.md"` |
