...
| Métrica | Valor | Fonte |
|---------|-------|-------|
| Tests | **1118/1118** ✅ default + **18/18** ✅ test:soak (deep-soak isolado) | `vitest run` 2026-05-12 |
| Test files | 98 | `find tests -name "*.test.js"` |
| Specs totais | **119** | `find specs -name "SPEC-*.md"` |
