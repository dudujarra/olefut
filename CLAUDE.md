...
| Métrica | Valor | Fonte |
|---------|-------|-------|
| Tests | **1036/1036** ✅ default + **18/18** ✅ test:soak (deep-soak isolado) | `vitest run` 2026-05-12 |
| Test files | 90 | `find tests -name "*.test.js"` |
| Specs totais | **108** | `find specs -name "SPEC-*.md"` |
