...
public class SaveQuaternionData : MonoBehaviour
{
	...
	public void SaveData()
	{
		...
		Quaternion content = new Quaternion(x, y, z, w);
		FileManagement.SaveFile("qData", content, isOn);
	}

	public void ReadData()
	{
		bool isOn = toggleEnc0.isOn;
		Quaternion quaternion = FileManagement.ReadFile<Quaternion>("qData", isOn);
		labelOut.text = quaternion.ToString();
	}
}
